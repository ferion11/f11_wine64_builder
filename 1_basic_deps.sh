...
# removed: xserver-xorg-dev xserver-xorg-dev:i386 libgcrypt20-dev:i386 libgnutls28-dev:i386 libicu-dev:i386 libtiff-dev:i386 libxml2-dev:i386 libcupsimage2-dev:i386 libxslt1-dev:i386 libsdl2-dev libsdl2-dev:i386 libgstreamer-plugins-base1.0-dev:i386
