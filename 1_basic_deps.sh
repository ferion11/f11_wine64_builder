...
sudo add-apt-repository -y ppa:mc3man/bionic-media >/dev/nullhttps://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/source/wine-staging_5.17~bionic.orig.tar.gz
...
sudo apt-get -y build-dep wine-staging wine-staging:i386 || die "* apt main replace"
#sudo apt-get -q -y install libfreetype6-dev libfreetype6-dev:i386 libfontconfig1-dev libfontconfig1-dev:i386 libglu1-mesa-dev libglu1-mesa-dev:i386 libosmesa6-dev libosmesa6-dev:i386 libvulkan-dev libvulkan-dev:i386 libvulkan1 libvulkan1:i386 libpulse-dev libpulse-dev:i386 libopenal-dev libopenal-dev:i386 libncurses-dev libncurses-dev:i386 libgnutls28-dev libgnutls28-dev:i386 libtiff-dev libtiff-dev:i386 libldap-dev libldap-dev:i386 libcapi20-dev libcapi20-dev:i386 libpcap-dev libpcap-dev:i386 libxml2-dev libmpg123-dev libmpg123-dev:i386 libgphoto2-dev libgphoto2-dev:i386 libsane-dev libsane-dev:i386 libcupsimage2-dev libcupsimage2-dev:i386 libkrb5-dev libkrb5-dev:i386 libgsm1-dev libgsm1-dev:i386 libxslt1-dev libv4l-dev libv4l-dev:i386 libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libgstreamer-plugins-base1.0-dev:i386 libudev-dev libudev-dev:i386 libxi-dev libxi-dev:i386 liblcms2-dev liblcms2-dev:i386 libibus-1.0-dev libibus-1.0-dev:i386 ocl-icd-opencl-dev ocl-icd-opencl-dev:i386 libxinerama-dev libxinerama-dev:i386 libxcursor-dev libxcursor-dev:i386 libxrandr-dev libxrandr-dev:i386 libxcomposite-dev libxcomposite-dev:i386 libavcodec57 libavcodec57:i386 libavcodec-dev libavcodec-dev:i386 libswresample2 libswresample2:i386 libswresample-dev libswresample-dev:i386 libavutil55 libavutil55:i386 libavutil-dev libavutil-dev:i386 libusb-1.0-0-dev libusb-1.0-0-dev:i386 libgcrypt20-dev libgcrypt20-dev:i386 libasound2-dev libasound2-dev:i386 libjpeg8-dev libjpeg8-dev:i386 libldap2-dev libldap2-dev:i386 libx11-dev libx11-dev:i386 zlib1g-dev zlib1g-dev:i386 libcups2 libcups2:i386 libdbus-1-3 libdbus-1-3:i386 libicu-dev libncurses5 libncurses5:i386 libwxgtk3.0-gtk3-dev libsdl2-dev:i386 libfaudio-dev:i386 libfaudio0:i386 libvkd3d-dev:i386 || die "* main apt erro!"
